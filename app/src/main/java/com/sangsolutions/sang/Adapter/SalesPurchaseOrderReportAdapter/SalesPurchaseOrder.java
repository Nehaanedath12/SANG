...
public class SalesPurchaseOrder {
    String sDocNo,Date,delDate,Account1,Account2,qty,sNarration,Product,Remarks,Tag1,Tag2,Tag3,Tag4,Tag5,Tag6,Tag7,Tag8;

    public SalesPurchaseOrder(String sDocNo, String date,String delDate, String account1, String account2,
                              String qty, String product, String tag1,
                              String tag2, String tag3, String tag4, String tag5, String tag6,
                              String tag7, String tag8) {
        this.sDocNo = sDocNo;
        Date = date;
