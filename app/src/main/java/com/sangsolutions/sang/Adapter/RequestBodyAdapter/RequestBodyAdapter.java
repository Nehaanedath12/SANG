package com.sangsolutions.sang.Adapter.RequestBodyAdapter;
...
public class RequestBodyAdapter extends RecyclerView.Adapter<RequestBodyAdapter.ViewHolder> {
    Context context;
    ...
    public interface OnClickListener {
        void onItemClick(RequestClass requestClass, int position);

        void onDeleteClick(List<RequestClass> list, int position);
    }


    public RequestBodyAdapter(Context context, List<RequestClass> list, int tagTotalNumber, int iDocType) {
    ...
    @NonNull
    @Override
    public RequestBodyAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.d("productNamee",":ll");
        View view= LayoutInflater.from(context).inflate(R.layout.request_body_adapter,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull RequestBodyAdapter.ViewHolder holder, int position) {
