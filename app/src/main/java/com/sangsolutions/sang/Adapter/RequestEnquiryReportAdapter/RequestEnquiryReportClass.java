...
public class RequestEnquiryReportClass {
    String sDocNo,Date,qty,sNarration,Product,Remarks,Tag1,Tag2,Tag3,Tag4,Tag5,Tag6,Tag7,Tag8;

    public RequestEnquiryReportClass(String sDocNo, String date, String qty,
                                     String product, String tag1, String tag2,
                                     String tag3, String tag4, String tag5, String tag6, String tag7,
                                     String tag8) {
        this.sDocNo = sDocNo;
        Date = date;
        this.qty = qty;
