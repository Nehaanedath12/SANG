...
import com.sangsolutions.sang.Fragment.SalesPurchaseFragment.SalesPurchaseHistoryFragmentArgs;
...
public class PurchaseBatchHistoryFragment extends Fragment {

    FragmentBatchPurchaseHistoryBinding binding;
    int iDocType;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding=FragmentBatchPurchaseHistoryBinding.inflate(getLayoutInflater());
        try {
        ...
        iDocType = PurchaseBatchHistoryFragmentArgs.fromBundle(getArguments()).getIDocType();
        ...
        binding.refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                NavDirections action= HomeFragmentDirections.actionHomeFragmentToPurchaseBatchHistoryFragment(18);
        ...
        binding.fabAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavDirections action= PurchaseBatchHistoryFragmentDirections
                        .actionPurchaseBatchHistoryFragmentToPurchaseBatchFragment().setIDocType(18).setEditMode(false).setITransId(0);
                navController.navigate(action);
            }
        });
...
//                        }
    ...
    private void adapterOnItemClick(int iTransId, int position) {
        if(!selectionActive) {
            NavDirections action= PurchaseBatchHistoryFragmentDirections
                    .actionPurchaseBatchHistoryFragmentToPurchaseBatchFragment().setIDocType(iDocType).setEditMode(true).setITransId(iTransId);
            navController.navigate(action);
        }
        else {
            enableActionMode(position);
