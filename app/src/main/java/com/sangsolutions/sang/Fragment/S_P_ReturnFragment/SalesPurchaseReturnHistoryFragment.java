package com.sangsolutions.sang.Fragment.S_P_ReturnFragment;
...
public class SalesPurchaseReturnHistoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding.refresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                NavDirections action= HomeFragmentDirections.actionHomeFragmentToSalesPurchaseReturnHistoryFragment(toolTitle+" History",iDocType);
    ...
    private void loadDatasFromDB() {
        ...
        historyAdapter.notifyDataSetChanged();
        alertDialog.dismiss();
        Cursor cursor=helper.getDataFromS_P_return_by_Itype(iDocType);
    ...
    private void deleteFromDB(int iTransId, String sDocNo) {
        ...
        if(helper.deleteSP_return_Header(iTransId,iDocType,sDocNo)){
