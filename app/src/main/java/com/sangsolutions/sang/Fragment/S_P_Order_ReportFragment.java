...
import com.sangsolutions.sang.databinding.FragmentReportSalesPurchaseOrderBinding;
...
public class S_P_Order_ReportFragment extends Fragment {
  FragmentReportSalesPurchaseOrderBinding binding;
    ...
    String userId="0";
    List<SalesPurchaseOrder>reportList;
    SalesPurchaseOrderReportAdapter reportAdapter;
    AlertDialog alertDialog;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding=FragmentReportSalesPurchaseOrderBinding.inflate(getLayoutInflater());
      ...
      reportAdapter=new SalesPurchaseOrderReportAdapter(requireActivity(),reportList);
  ...
  private void loadingToClass(JSONArray response) {
    ...
    try {
      ...
      for (int i=0;i<jsonArray.length();i++){
        ...
        SalesPurchaseOrder report=new SalesPurchaseOrder(
        ...
        Log.d("listsizee", jsonObject.getString("DeliveryDate"));
