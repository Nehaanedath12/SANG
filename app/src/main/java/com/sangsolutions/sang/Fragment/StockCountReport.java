...
import com.sangsolutions.sang.Adapter.StockCountReportAdapter.StockCountClass;
import com.sangsolutions.sang.Adapter.StockCountReportAdapter.StockCountReportAdapter;
import com.sangsolutions.sang.Database.DatabaseHelper;
import com.sangsolutions.sang.R;
import com.sangsolutions.sang.Tools;
import com.sangsolutions.sang.URLs;
import com.sangsolutions.sang.databinding.FragmentStockcountReportBinding;
...
public class StockCountReport extends Fragment {
    FragmentStockcountReportBinding binding;
    ...
    String userId="0";
    List<StockCountClass>reportList;
    StockCountReportAdapter reportAdapter;
    AlertDialog alertDialog;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding=FragmentStockcountReportBinding.inflate(getLayoutInflater());
        ...
        reportAdapter=new StockCountReportAdapter(requireActivity(),reportList);
    ...
    private void loadingToClass(JSONArray response) {
        ...
        try {
            ...
            for (int i=0;i<jsonArray.length();i++){
                ...
                StockCountClass report=new StockCountClass(
                ...
                Log.d("listsizee", jsonObject.getString("StockDate"));
