...
import com.sangsolutions.sang.databinding.FragmentReportSalesPurchaseReturnBinding;
...
public class S_P_Return_ReportFragment extends Fragment {

    FragmentReportSalesPurchaseReturnBinding binding;
    ...
    String userId="0";
    List<SalesPurchaseReport>reportList;
    SalesPurchaseReportAdapter reportAdapter;
    AlertDialog alertDialog;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding=FragmentReportSalesPurchaseReturnBinding.inflate(getLayoutInflater());
        ...
        reportAdapter=new SalesPurchaseReportAdapter(requireActivity(),reportList);
    ...
    private void loadingToClass(JSONArray response) {
        ...
        try {
            ...
            for (int i=0;i<jsonArray.length();i++){
                ...
                SalesPurchaseReport report=new SalesPurchaseReport(
